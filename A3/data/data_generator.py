...
def generate_market_csv(
    ...
    with open(filename, 'w', newline='') as csvfile:
        ...
        for _ in range(num_ticks):
            ...
            # every 100 ticks print.
            if _ % 100 == 0:
                print(f"Generated {_} ticks")
...
if __name__ == "__main__":
    ...
    generate_market_csv(
        symbol="AAPL",
        start_price=150.0,
        filename="market_data_1000.csv",
        num_ticks=1000,
        volatility=0.02,
        interval=0.01
    )
    print("market_data_10000.csv generated with 10000 ticks.")

    generate_market_csv(
        symbol="AAPL",
        start_price=150.0,
        filename="market_data_10000.csv",
        num_ticks=10000,
        volatility=0.02,
        interval=0.01
    )
    ...
    generate_market_csv(
        symbol="AAPL",
        start_price=150.0,
        filename="market_data_100000.csv",
        num_ticks=100000,
        volatility=0.02,
        interval=0.01
    )
    print("market_data_100000.csv generated with 100000 ticks.")
